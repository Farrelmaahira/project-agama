<div class=" w-full md:h-22 h-20 flex items-center p-4 md:px-28 px-6 text-primary justify-between">
    ...
    <div class="hidden md:block">
        <ul class="flex md:text-[18px] gap-1 text-sm font-normal bg-tertiary px-2 py-3 rounded-full ease-in-out">
            <li>
                <a class=" cursor-pointer px-2 py-1 rounded-full">sunnah</a>
            </li>
            <li>
                <a class=" cursor-pointer px-2 py-1 rounded-full">doa</a>
            </li>
            <li>
                <a class="bg-primary text-white cursor-pointer px-2 py-1 rounded-full">baca quran</a>
            </li>
        </ul>
    </div>
</div>
