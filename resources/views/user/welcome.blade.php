<x-layouts.app>
    <section class="md:h-[100vh] h-[85vh] w-full relative" id="hero">
        <div class="absolute inset-0 w-full h-[100vh]">
            {{-- content tengah --}}
            <div class="md:translate-y-36 translate-y-24 h-80 w-full flex justify-center items-center  gap-12">
                <div class="justify-end items-end md:grid hidden">
                    <img src="/images/muslim-family.png" class="w-[28rem] object-cover">
                </div>
                <div class=" grid md:justify-start justify-center my-auto">
                    <div class="text-primary md:w-[40rem] w-[18rem] h-full">
                        ...
                        <p class="my-6 md:text-lg text-sm font-normal mb-10 text-center md:text-start">Islam TIK (ITIK) adalah platform yang dirancang agar mahasiswa TIK dapat dengan mudah mempelajari agama islam. Mereka juga bisa membaca Al-Qur’an dan mempelajari sunnah-sunnah nabi Muhammad SAW disini.</p>
                        <div class="flex justify-center md:justify-start">
                            <button id="scrollButton"
                                class="md:p-4 p-2 border-2 border-primary cursor-pointer hover:text-primary hover:bg-transparent rounded-lg bg-primary text-white">
                                Read Quran
                            </button>
                        </div>
                    </div>
